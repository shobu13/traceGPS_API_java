...
public class Utilisateur {
    ...
    public String getMdpSha1() {
        return _mdpSha1;
    }

    public void setMdpSha1(String unMdpSha1) {
        _mdpSha1 = unMdpSha1;
    }
    ...
    public void setAdrMail(String uneAdrMail) {
        _adrMail = uneAdrMail;
    }
    ...
    public void setNbTraces(int unNbTraces) {
        _nbTraces = unNbTraces;
    }

    public Date getDateDerniereTrace() {
        return _dateDerniereTrace;
    }

    public void setDateDerniereTrace(Date uneDateDerniereTrace) {
        _dateDerniereTrace = uneDateDerniereTrace;
    }
